...
void generarCadenas(char *cadena, int n, int pos, int *contador, int maxCadenas){
    ...
    for(i=0;i<2;i++){
        ...
        strcpy(&cadena[pos], conjunto[i]);
        generarCadenas(cadena,n,pos+strlen(conjunto[i]),contador,maxCadenas);
    }
}
...
void generarCadenas1(char *cadena1, int n1, int pos, int *contador1, int maxCadenas1){
    ...
    for(i=0;i<2;i++){
        ...
        strcpy(&cadena1[pos],conjunto[i]); 
        generarCadenas1(cadena1,n1,pos + strlen(conjunto[i]),contador1,maxCadenas1); 
    }
}
